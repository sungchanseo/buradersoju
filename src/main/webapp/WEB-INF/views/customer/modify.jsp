...
<tr>
	<th>거래처유형</th>
	<td><label><input type="radio" name="cust_type" id="cust_type" value="사업자(국내)"
...
<tr>
	...
	<th>FAX번호</th>
	<td><input type="text" name="cust_fax" id="cust_fax" value="${customerVO.cust_fax }"></td>
</tr>
<tr>
	<th>종목</th>
	<td>
	...
	<td>
		...
		<input type="text" name="address1" id="address1" size="45" onclick="addr();"><br>
		<input type="text" name="address2" id="address2" size="45" placeholder="상세주소를 입력해주세요."maxlength="45">
	</td>
</tr>
<tr>
	<th>기타</th>
