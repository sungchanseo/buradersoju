              ...
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <h6 class="font-weight-light">사원을 등록해주세요</h6>
	                <form class="pt-3" action="" method="post">
		                  ...
		                  <div class="form-group">
		                    <input type="text" class="form-control form-control-lg" id="emp_pw" name="emp_pw" placeholder="비밀번호">
		                  </div>
		                   <div class="form-group">
		                    <input type="text" class="form-control form-control-lg" id="emp_name" name="emp_name" placeholder="이름">
		                  </div>
		                  <div class="form-group">
		                    <input type="text" class="form-control form-control-lg" id="emp_email" name="emp_email" placeholder="이메일">
		                  </div>
		                  <div class="form-group">
		                  ...
		                  <div class="form-group">
		                    <input type="text" class="form-control form-control-lg" id="join_date" name="join_date" placeholder="입사일">
		                  </div>
		                  <div class="mb-4">
		                  </div>
		                  <div class="mt-3">
