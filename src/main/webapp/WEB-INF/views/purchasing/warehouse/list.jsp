...
<body>
	...
	<h1 class="card-title">
		<font style="vertical-align: inherit;"><font
			style="vertical-align: inherit;">창고 리스트</font></font>
	</h1>

	<div>
		<ul class="nav nav-tabs tab-no-active-fill" role="tablist">
			<li class="nav-item"><a class="nav-link ps-2 pe-2 active"
				id="stage1-tab" data-bs-toggle="tab" href="#stage1" role="tab"
				aria-controls="stage1" aria-selected="true">자재창고</a></li>
			<li class="nav-item"><a class="nav-link ps-2 pe-2"
				id="stage2-tab" data-bs-toggle="tab" href="#stage2" role="tab"
				aria-controls="stage2" aria-selected="false">상품창고</a></li>
		</ul>
				<!-- 탭 내용 -->
		<div class="tab-content tab-no-active-fill-tab-content">
			<div class="tab-pane fade active show" id="stage1" role="tabpanel"
