							...
							<div class="form-group">
								...
								<div> <!-- 탭 영역 시작 -->
									...
									<ul class="nav nav-tabs tab-no-active-fill" role="tablist">
										<li class="nav-item">
											<a class="nav-link ps-2 pe-2 active" id="stage1-tab" data-bs-toggle="tab" href="#stage1" role="tab" aria-controls="stage1" aria-selected="true">혼합</a>
										</li>
										<li class="nav-item">
										...
										<li class="nav-item">
											<a class="nav-link ps-2 pe-2" id="total-tab" data-bs-toggle="tab" href="#total" role="tab" aria-controls="total" aria-selected="false">전체</a>
										</li>
									</ul>
											...
											<div class="d-flex justify-content-between">
											  ...
											  <form action="/production/productionList" method="get" style="display: inline;">
												<select name="selector">
													...
													<option value="stage3_date">작업완료일시</option>
												</select>
