...
//	private String product_id;
	...
	public String toString() {
		return "ProductionVO [cont_id=" + cont_id + ", cont_qty=" + cont_qty + ", emp_name=" + emp_name + ", ma_name="
				...
				+ stage3_defQty + ", stage3_date=" + stage3_date + ", production_qty=" + production_qty + ", qc_num="
				+ qc_num + ", qc_emp=" + qc_emp + ", qc_date=" + qc_date + ", qc_qty=" + qc_qty + ", qc_state="
				+ qc_state + ", def_code=" + def_code + ", def_qty=" + def_qty + ", bt_date=" + bt_date + ", bt_qty="
				+ bt_qty + ", bt_defQty=" + bt_defQty + "]";
	}
